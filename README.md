...
仓库同时包含 [学习 · Study Companion](projects/obsidian-study-companion)：基于 Obsidian 与 GPT 的个人大学学习插件，支持按需引用笔记的连续问答、分步练习与基于真实作答记录的复习。当前为 0.1.1 实验版，尚未发布到 Obsidian Community Plugins；安装方法、限制和长期设计见插件目录。
